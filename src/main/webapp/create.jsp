...
<div class="container my-5">
    ...
    <form action="${pageContext.request.contextPath}/create-petition" method="post" class="mx-auto" style="max-width: 600px;">
        <div class="mb-3">
        ...
        <a href="${pageContext.request.contextPath}/" class="btn btn-secondary ms-3">Back to Home</a>
    </form>
</div>
<!------ Footer -->
